...
func (e Errors) Error() string {
	...
	buff.WriteString("openpab: ")
	for i := 0; i < len(e); i++ {
		buff.WriteString("code(")
		buff.WriteString(e[i].ErrorCode)
		buff.WriteString(")--msg(")
		buff.WriteString(e[i].ErrorMessage)
		buff.WriteString(")")
		if i != len(e)-1 {
			buff.WriteString(" ")
		}
...
func CodeText(errCode string) string {
...
var codeText = map[string]string{
	...
	Err936:  "交易要素不全",
	Err923:  "数据库操作失败",
	Err957:  "交易异常,请稍候查询交易结果",
	Err020:  "无符合条件记录",
	Err021:  "错误的功能码",
	Err022:  "监管帐户必须是对公账号",
	Err025:  "主机返回错误",
	Err026:  "企业代码错误或未开通服务",
	Err027:  "所输监管账号未开户或已销户",
	Err030:  "请求页码错误",
	Err031:  "子账号不存在或已无效",
	Err033:  "绑定账号不存在",
	Err042:  "金额不能小于等于0",
	...
	Err133:  "单笔提现超过限额",
	Err134:  "账号已被绑定",
	Err135:  "短信动态码验证中，请稍后重新发起",
	Err136:  "系统繁忙中，请稍后重试",
	Err137:  "验证信息不存在",
	Err138:  "短信动态码验证不相符",
	Err139:  "短信发送失败",
	Err140:  "地区名称不正确，无法查询到对应县市",
	Err141:  "会员新绑定帐号与原账号户名不符",
	Err142:  "会员代码已存在",
	Err143:  "当前时间不允许发起此交易",
	Err144:  "该证件信息已签约过交易所",
	Err145:  "原有申请在待验证时间内，请稍后再发起",
	Err146:  "该帐号已被绑定，请更换银行帐号",
	Err147:  "时间已超过48小时，请重新发起",
	Err148:  "该流水号对应的交易已撤销",
	Err149:  "子账户与原订单不一致",
	Err150:  "证件信息或银行预留手机号不符",
	Err151:  "身份证格式错误",
	Err152:  "市场资金清算中，请稍后再试",
	Err153:  "企业代码不存在",
	Err154:  "参数未配置",
	Err155:  "子账户已实名不允许合并",
	Err156:  "未开通网上支付功能,无法验证",
	Err157:  "此卡号您已认证错误超过6次,请次日再试",
	Err158:  "其它错误",
	Err159:  "该证件已绑定其它子账户",
	Err160:  "支付指令号重复",
	Err161:  "支付指令号不存在或已处理",
	...
	Err175:  "户名不符",
	Err176:  "帐号不存在",
	Err177:  "冻结解冻相关交易金额必须大于0",
	Err178:  "交易初始化异常",
	Err179:  "该电商平台未配置参数信息",
	Err180:  "订单不存在",
	Err181:  "订单已存在,插入失败,事务回滚",
	Err182:  "获取平台流水号失败",
	Err183:  "提现关闭,请确认在途资金是否按规定进账",
	Err184:  "未开通橙e付,无法通过橙e付提现",
	Err185:  "橙e付开通失败,无法通过橙e付提现",
	Err186:  "赎回方式有误",
	Err187:  "门户预检查异常",
	Err188:  "门户预检查失败",
	Err189:  "银联鉴权异常",
	Err190:  "银联鉴权失败",
	Err191:  "平台帐号必须绑定对应本行一般结算户",
	Err192:  "未配置该会员属性",
	Err193:  "橙e门户未开通,无法理财开户",
	Err194:  "橙e付充值异常",
	Err195:  "橙e付充值失败",
	Err196:  "行内转账异常",
	Err197:  "行内转账失败",
	...
	Err211:  "暂不支持查询全部",
	Err212:  "银联鉴权超级网银行号为空",
	Err213:  "超级网银行号对应的鉴权行号未配置",
	Err214:  "仍有未完成的订单不允许销户",
	Err215:  "橙E帐号开户未绑卡",
	Err216:  "橙E帐号开户未上传身份影像",
	Err217:  "橙E帐号待补充开户资料",
	Err218:  "帐号基本信息查询异常",
	Err220:  "第n对绑定关系不存在",
	Err221:  "该子帐号禁止提现",
	...
	Err260:  "证件与姓名不一致",
	Err261:  "人行查询通道已关闭",
	Err262:  "新监管帐号不能为原结算帐号",
	Err263:  "金额提现中不能解绑",
	Err264:  "不存在来账鉴权流水",
	Err265:  "来账鉴权匹配中,请确认已转账验证",
	Err266:  "暂时只支持改为商户子账户",
	Err267:  "尚有收单渠道未解约,不能变更",
	Err268:  "非自营平台不能使用该分支",
	Err269:  "订单信息与上送信息不一致",
	Err270:  "原交易信息不存在",
	Err271:  "可退金额不足",
	...
	Err273:  "退款手续费须为0",
	Err274:  "出入金账户余额不足",
	Err275:  "第三方流水号与交易流水号重复,请核查",
	Err276:  "收单专属子账户不存在",
	Err277:  "是已经调过帐或者是已发起过退款",
	Err278:  "该笔充值当前入账帐号非该收单渠道子账户,不可调账",
	Err279:  "该笔清算流水不存在",
	Err280:  "只支持对账成功后发起调账",
	Err281:  "交易金额与原订单金额不一致",
	Err282:  "该订单号已经报送成功,无需进行平台补账",
	Err283:  "订单状态失败或异常",
	Err284:  "输入的交易金额与接口查询出的交易金额不一致",
	Err285:  "平台上送的渠道类型与接口返回不一致",
	Err286:  "内部调用交易504130在途充值失败",
	Err287:  "不支持的证件类型",
	Err288:  "备注字段为空,无法解析",
	Err289:  "客户注册任务仍在处理中,请稍后再尝试本请求",
	Err290:  "通过绑卡、或者存量客户通过补录接口注册数字口袋后再尝试申请,或者联系分行通过中台添加白名单",
	Err291:  "未配置白名单展示",
	Err317:  "订单可用余额不足",

	E10002: "无匹配的会员子账户或会员子账户已失效",
	...
	EF0027: "T0订单成功但资金尚未到账，主机记账流水号为空，无法补帐",
	EF0028: "登记异步记账失败",
	EF0034: "归集后退款仅支持单笔",
	EF0038: "获取异步消息失败",
	EF0048: "转入子账户数不能小于0或大于5",
	EF0058: "异步任务超时未处理删除",
}
